...
public abstract class Offsets
{
    ...
    public static ReadOnlySpan<long> RaidBlockPointerBase => [0x4759480, 0x198, 0x88, 0x40];
    public static ReadOnlySpan<long> RaidBlockPointerKitakami => [0x4759480, 0x198, 0x88, 0xCD8];
    public static ReadOnlySpan<long> RaidBlockPointerBlueberry => [0x4759480, 0x198, 0x88, 0x1958];
